...
public class CommandsManager {
    ...
    public void sentQueryRemoteCommandList(List<HttpNameValuePair> parameters, WebServiceRequest webService) {
        if (mListener != null) {
            if (mLastReceivedCommandId != null) {
                parameters.add((new HttpNameValuePair("lastCommandId", mLastReceivedCommandId)));
            }
            sentQueryRemoteCommandListImpl(parameters, webService);
        }
    }

    private void sentQueryRemoteCommandListImpl(List<HttpNameValuePair> parameters, WebServiceRequest webService) {
        try {
